...
Model triangle(vs, 3, sizeof(vs), GL_STATIC_DRAW);
...
void setup() {
    triangle.schema(3, GL_FLOAT, GL_FALSE, 0);
    triangle.schema(3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat));

    triangle.SetShaderFilePath(GL_VERTEX_SHADER, vshaderFilePath);
    triangle.SetShaderFilePath(GL_FRAGMENT_SHADER, fshaderFilePath);
